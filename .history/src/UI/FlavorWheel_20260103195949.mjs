export const FlavorWheel = {
    render() {
        ...
        // Using CSS Grid structure for precise alignment of ticks and plot
        container.innerHTML = `
            <div class="flavor-grid-layout">
                ...
                <div id="flavor-plot" class="flavor-plot">
                    <div class="quad q-tl"><span>SAVORY & LEAN</span></div>
                    <div class="quad q-tr"><span>SWEET & RICH</span></div>
                    ...
                    <div class="matrix-labels">
                     ...
                     <div class="matrix-legend">
                        ...
                        <div class="legend-explanation">
                            Map based on estimated ingredient percentages. Products lacking formula data are scattered dynamically.
                        </div>
                    </div>
                </div>
            </div>`;
    ...
    async plotProducts(ssot, locale) {
        ...
        // Clear old dots only. Keep quads, grids, axes.
        ...
        for (const [id, data] of products) {
            ...
            // Add 2.5% padding to coordinate so dots don't sit exactly on the border line
    ...
    getCoords(id, formula, ssot) {
        ...
        // 3. SCALING (Map data to 5%-95% range for visibility)
    ...
    generatePseudoRandomCoords(id) {
        ...
        // Place dots randomly within the central 70% area
