export const FlavorWheel = {
                ...
                <div class="info-footer">
                    <div class="matrix-legend">
                        ...
                        <div class="legend-explanation">
                            Plotting estimated pH vs. Sucrose. Lower pH = Higher Acidity.
                        </div>
                    </div>
                </div>
            </div>`;
    ...
    async plotProducts(ssot, locale) {
        ...
        for (const [id, data] of products) {
            ...
            dot.onclick = (e) => {
                e.stopPropagation();
                if (window.showStage) window.showStage('browser-view');
    ...
    getCoords(id, formula, ssot) {
        ...
        const estimatedPH = 6.0 - (Math.min(acidity, 0.5) * 6); 
    ...
    generatePseudoRandomCoords(id) {
        ...
        return { x: 10 + (hash * 13 % 80), y: 10 + (hash * 7 % 80) };
    }
};